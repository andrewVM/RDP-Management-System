...
class NavleftAdmin extends React.Component {
    constructor(props){
        super(props);
    }
    ...
    render() {
        ...
        return (
            <div className='NavleftAdmin' style={{display: 'flex', justifyContent: 'start' }}  >
                                ...
                                <tr>
                                    <td align="left" style={{paddingLeft: '1px'}} valign='top' height='600px' >
                                        ...
                                        <div class="EnclosureBox">
                                            ...
                                            <div> &nbsp; </div>
                                            <div className="SectionEnclosureBox bg-lightest-blue pa2"><Link className='red' to="/dashboard"  >DASHBOARD </Link></div>
                                            <div> &nbsp; </div>
                                            <div className="SectionEnclosureBox bg-lightest-blue pa2"><a href="/projectsa">PROJECTS</a></div>
                                            <div> &nbsp; </div>
                                            <div className="SectionEnclosureBox bg-lightest-blue pa2"><Link to="/organizationsa" >ORGANIZATIONS</Link></div>
                                            <div> &nbsp; </div>
