...
class NavleftM extends React.Component {
    constructor(props){
        super(props);
    }
    ...
    render() {
        ...
        return (
            <div className='NavleftM' style={{display: 'flex', justifyContent: 'start' }}  >
                                ...
                                <tr>
                                    <td align="left" style={{paddingLeft: '1px'}} valign='top' height='600px' >
                                        ...
                                        <div class="EnclosureBox">
                                            ...
                                            <div> &nbsp; </div>
                                            <div className="SectionEnclosureBox bg-lightest-blue pa2"><a href="/projects">PROJECTS</a></div>
                                            <div> &nbsp; </div>
