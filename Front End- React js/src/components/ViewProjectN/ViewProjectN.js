...
const ViewProjectN = () => {
    ...
    return(
        <div className='ViewProjectN' style={{display: 'flex', width: '100%' , justifyContent: 'start'}} >
                        ...
                        activities.map((activ, index) => {
                            ...
                            return (
                                <ul className='activity' key={index} >
                                    <li>
                                        <Link to= {{pathname: "/projects/:project_id/:activity_id", state: activ.activity_id }}  >
