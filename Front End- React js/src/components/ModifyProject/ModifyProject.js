...
class ModifyProject extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.setState({project_name: responsi.data[0].p_name})
        this.setState({project_descript: responsi.data[0].p_description})
        this.setState({project_goal: responsi.data[0].p_goals})
        this.setState({project_target: responsi.data[0].p_target})
        this.setState({project_region: responsi.data[0].p_region})
        this.setState({project_district: responsi.data[0].p_district})
        this.setState({project_ward: responsi.data[0].p_ward})
        this.setState({project_donor: responsi.data[0].p_donor})
        this.setState({starting_date: responsi.data[0].p_starting_date})
        this.setState({ending_date: responsi.data[0].p_ending_date})
        this.setState({project_duration: responsi.data[0].p_duration})
        this.setState({project_status: responsi.data[0].p_status})
        this.setState({project_category: responsi.data[0].p_category})
        this.setState({project_remarks: responsi.data[0].p_remarks})
        this.setState({organization_id: responsi.data[0].organization_id})
    }
    ...
    onValidsub = () => {
        ...
        if(!this.state.organization_id){
            this.setState({organError: '**Cannot be blank**'})
        }
    ...
    onSubmitAddProject = (event) => {
        ...
        fetch('http://localhost:3001/projecti/' + this.state.project_id, {
          method: 'PUT',
    ...
    render(){
        return(
            <div className='ModifyProject pa3'>
                <h4 className='underline' >Update Project</h4>
                <form onSubmit={this.onSubmitAddProject} >
                    <div className="mb-4 row">
                        <label htmlFor="project_id" className="col-auto col-form-label">Project_ID:</label>
                        <div className="col-sm-7">
                            <input type="text" className="form-control" id="project_id" value={this.state.project_id} onChange={this.onProjectIdChange} />
                     ...
                     <br />
                    <div className="mb-4 row">
                        <label htmlFor="project_name" className="col-auto col-form-label">Project Name:</label>
                        <div className="col-sm-7">
                            <input type="text" className="form-control" id="project_name" value={this.state.project_name} onChange={this.onProjectNameChange} />
                    ...
                    <div className="mb-4 row">
                        ...
                        <div className="col-sm-7">
                            <textarea type="text" className="form-control" id="project_descript" value={this.state.project_descript} onChange={this.onProjectDescriptChange} />
                        </div>
                    </div>
                    <div className="mb-4 row">
                        <label htmlFor="project_goal" className="col-auto col-form-label">Project Goals:</label>
                        <div className="col-sm-8">
                            <textarea type="text" className="form-control" id="project_goal" value={this.state.project_goal} onChange={this.onProjectGoalChange} />
                        </div>
                    </div>
                    <div className="mb-4 row">
                        <label htmlFor="project_target" className="col-auto col-form-label">Project Target:</label>
                        <div className="col-sm-8">
                            <textarea type="text" className="form-control" id="project_target" value={this.state.project_target} onChange={this.onProjectTargetChange} />
                        </div>
                    </div>
                    ...
                    <div className="mb-4 row">
                        ...
                        <div className="col-sm-8">
                            <input type="text" className="form-control" id="project_donor" value={this.state.project_donor} onChange={this.onProjectDonorChange} />
                        </div>
                    </div>
                    <div className='mb-4 row' >
                        ...
                        <div className='row col-auto'>
                            <select className="form-select" id='project_category'  onChange={this.onProjectCategoryChange} >
                                <option value={this.state.project_category} selected>{this.state.project_category}</option>
                    ...
                    <div className='row mb-4' >
                        <label htmlFor='' className="col-auto col-form-label">Project Location:</label> 
                        <div className='row col-auto' >
                            <select className="form-select form-select-lg" aria-label=".form-select-lg example" id='project_region' value={this.state.selectreg} onChange={this.onProjectRegionChange.bind(this)} >
                                <option selected>{this.state.project_region}</option>
                            ...
                            <select className="form-select form-select-sm" aria-label=".form-select-sm example" id='project_district' onChange={this.onProjectDistrictChange} >
                                <option selected >{this.state.project_district}</option>
                                {
                            ...
                            <div className='col-auto' >
                                <input className="form-control" type="text" placeholder="Enter Ward" aria-label=".form-control-sm example" id='project_ward' value={this.state.project_ward} onChange={this.onProjectWardChange} />
                            </div>
                        </div>

                    </div>
                    <div className="mb-4 row">
                        <label htmlFor="starting_date" className="col-auto col-form-label">Project Starting_date:</label>
                        <div className="col-sm-7">
                            <input type="date"  className="form-control" id="starting_date" value={Moment(this.state.starting_date).format('YYYY-MM-DD')} onChange={this.onStartingDateChange} />
                    ...
                    <div className="mb-4 row">
                        ...
                        <div className="col-sm-7">
                            <input type="date"  className="form-control" id="ending_date" value={Moment(this.state.ending_date).format('YYYY-MM-DD')} onChange={this.onEndingDateChange} />
                        </div>
                    </div>
                    <div className="mb-4 row">
                        <label htmlFor="project_duration" className="col-auto col-form-label">Project Duration:</label>
                        <div className="col-sm-7">
                            <input type="text" className="form-control" id="project_duration" value={this.state.project_duration} onChange={this.onProjectDurationChange} />
                        </div>
                    </div>
                    <div className="mb-4 row">
                        <label htmlFor="project_status" className="col-auto col-form-label">Project Status:</label>
                        <div className="col-sm-7">
                            <input type="text" className="form-control" id="project_status" value={this.state.project_status} onChange={this.onProjectStatusChange} />
                        </div>
                    </div>
                    <div className="mb-4 row">
                        <label htmlFor="project_remarks" className="col-auto col-form-label">Project Remarks:</label>
                        <div className="col-sm-7">
                            <textarea type="text" className="form-control" id="project_remarks" value={this.state.project_remarks} onChange={this.onProjectRemarksChange} />
                        </div>
                    </div>
